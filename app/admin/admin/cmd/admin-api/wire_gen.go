...
import (
	...
	admincfg "micro-one-api/app/admin/admin/internal/config"
	"micro-one-api/app/admin/admin/internal/data"
	adminserver "micro-one-api/app/admin/admin/internal/server"
	"micro-one-api/app/admin/admin/internal/service"
