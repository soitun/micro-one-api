...
// json_name tags.
type Config struct {
	Bootstrap *configconf.Bootstrap
}
...
func loadConfig(confPath string) (*Config, error) {
	...
	var bootstrap configconf.Bootstrap
...
func initBootstrap(b *configconf.Bootstrap) {
	if b.Server == nil {
		b.Server = &configconf.Server{}
	}
	if b.Server.Http == nil {
		b.Server.Http = &configconf.HTTP{}
	}
	if b.Server.Grpc == nil {
		b.Server.Grpc = &configconf.GRPC{}
	}
	if b.Data == nil {
		b.Data = &configconf.Data{}
	}
	if b.Data.Database == nil {
		b.Data.Database = &configconf.Database{}
	}
	if b.Data.Redis == nil {
		b.Data.Redis = &configconf.Redis{}
	}
	if b.Registry == nil {
		b.Registry = &configconf.Registry{}
	}
	if b.Registry.Consul == nil {
		b.Registry.Consul = &configconf.Consul{}
	}
	if b.Registry.Metadata == nil {
		b.Registry.Metadata = make(map[string]string)
	}
	if b.ConfigSvc == nil {
		b.ConfigSvc = &configconf.ConfigSvc{}
	}
	// no return
}
